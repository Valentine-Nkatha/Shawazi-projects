    ...
    <div className="min-h-screen bg-white flex flex-col font-jost justify-center relative overflow-hidden">
      ...
      <div className="w-full md:w-[40%] mx-auto z-10 bg-white p-6 md:p-8 rounded-lg shadow-lg">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 md:space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-primary text-white text-[16px] md:text-[20px] p-3 rounded-md shadow-md hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-foreground focus:ring-offset-2"
            disabled={loading}
          >
            {loading ? 'Creating account...' : 'Sign Up'}
          </button>
        </form>
        <p className="mt-4 text-center text-[14px] md:text-[16px] text-primary">
