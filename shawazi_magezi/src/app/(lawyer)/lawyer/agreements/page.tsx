      ...
      <div className="flex-1 p-6 mt-14 ">
        <div className="max-w-4xl mx-auto w-full">
          <div className="bg-white rounded-lg shadow-xl p-6 md:p-8">
            <h1 className="text-3xl md:text-4xl font-bold text-center mb-8 text-brown-700">
              Create Agreement
            </h1>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-14">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col">
                  ...
                  <select
                    {...register('buyer_id')}
                    className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white text-gray-800 text-lg"
                  >
