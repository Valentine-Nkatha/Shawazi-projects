            ...
            <table className="w-full text-left border-collapse min-w-[768px]">
              <thead className="bg-hover">
                <tr className="border-b">
                  <th className="p-3 text-white text-sm md:text-base lg:text-lg">
                    Date
                  </th>
                  <th className="p-3 text-white text-sm md:text-base lg:text-lg">
                    Status
                  ...
                  transactions
                    ...
                    .map((transaction, idx) => (
                      <tr key={idx} className="border-b border-primary">
                        <td className="p-3 text-sm md:text-base lg:text-lg">
                          {formatDate(transaction.date)}
                        </td>
                        <td className="p-3">
                          <span
                            className={`inline-block w-24 px-2 py-2 rounded-lg text-white text-center text-sm md:text-base ${
